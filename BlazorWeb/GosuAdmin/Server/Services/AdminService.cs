...
namespace GosuAdmin.Server.Services
{
    public class AdminService : grpcAdminService.grpcAdminServiceBase
    {
        ...
        // Get RoleDetail
        public override async Task<GetRoleDetail_Response> GetRoleDetail(Gosu.Admin.Services.String_Request request, ServerCallContext context)
        {
